...
var (
	// sample A2S_INFO data
	sampleServerInfoData = []byte{
	...
	// sample A2S_PLAYER data
	samplePlayerInfoData = []byte{
	...
	// sample A2S_RULES data
	sampleRuleInfoData = []byte{
...
// GetServerInfoWithTestData uses sample A2S_INFO test data for testing purposes.
func GetServerInfoWithTestData() error {
	si := sampleServerInfoData
...
// GetPlayerInfoWithTestData uses sample A2S_PLAYERS test data for testing purposes.
func GetPlayerInfoWithTestData() error {
	pi := samplePlayerInfoData
...
// GetRulesInfoWithTestData uses sample A2S_RULES test data for testing purposes.
func GetRulesInfoWithTestData() error {
	ri := sampleRuleInfoData
